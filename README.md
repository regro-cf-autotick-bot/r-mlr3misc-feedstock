...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-mlr3misc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-mlr3misc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install r-mlr3misc
```
...
It is possible to list all of the versions of `r-mlr3misc` available on your platform:
...
```
pixi search r-mlr3misc --channel conda-forge
```
